...
def test_year_contract_salary_employment_contract_first_init(rates_default,employment_settings_default,employment_contract_gross_6000)->None:

    ycs = YearContractSummary(rates_default,employment_settings_default,Decimal("6000"))
...
def test_year_contract_salary_mandate_contract_init_from_contract(rates_default,mandate_settings_default,mandate_contract_gross_6000)->None:
...
def test_year_contract_salary_work_contract_compare_to(rates_default,work_settings_default,work_contract_gross_6000)->None:
    ...
    assert ycs.compare_to(work_contract_gross_6000).salary_difference.net_salary == ycs.summary.net_salary - work_contract_gross_6000.net_salary
    assert ycs.is_compared==True
    assert ycs.summary == ycs['SUMMARY']
    assert ycs.salary_difference == ycs["DIFFERENCE"]


def test_year_contract_salary_self_employment_to_string(rates_default,self_employment_settings_default,self_employment_gross_6000)->None:
    ...
    assert ycs.compare_to(self_employment_gross_6000).salary_difference.net_salary == ycs.summary.net_salary - self_employment_gross_6000.net_salary
    assert ycs.is_compared==True
    assert ycs.summary == ycs['SUMMARY']
    assert ycs.salary_difference == ycs["DIFFERENCE"]
...
def test_year_contract_salary_self_employment_to_exported_dict(rates_default,self_employment_settings_default,self_employment_gross_6000)->None:
...
def test_year_contract_salary_employment_contract_modify_month(rates_default,employment_settings_default,employment_contract_gross_6000)->None:
    ...
    assert ycs["SUMMARY"].salary_gross == employment_contract_gross_6000.salary_gross * 9 - Decimal("1000")

def test_year_contract_salary_employment_contract_compared_raises(rates_default,employment_settings_default,employment_contract_gross_6000)->None:
...
def test_year_contract_salary_employment_contract_compared_to_other_ycs(rates_default,employment_settings_default,employment_contract_gross_6000,mandate_contract_gross_6000)->None:
