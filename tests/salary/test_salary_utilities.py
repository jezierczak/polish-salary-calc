...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            Decimal("0.0"),
            Decimal("17300.0"),
        ),  # 12000*0.12 - 300 = 14100+3200 = 17300
        (
            Decimal("20000.0"),
            Decimal("110000.0"),
            Decimal("4100.0"),
        ),  # 10000*0.12 - 300 = 900+3200 = 4100
        (
            Decimal("20000.0"),
            Decimal("120000.0"),
            Decimal("6100.0"),
...
def test_salary_utilities_calculate_tax(
    tax_base: Decimal, tax_base_sum: Decimal, out: Decimal
) -> None:
...
@pytest.mark.parametrize(
    "cost_ratio,base,cost_fifty_sum,out",
    [
...
def test_salary_utilities_calculate_author_right_cost(
    cost_ratio: Decimal, base: Decimal, cost_fifty_sum: Decimal, out: Decimal
) -> None:
...
@pytest.mark.parametrize(
    "social_security_base,social_security_base_sum,out",
    [
        (Decimal("0.0"), Decimal("0.0"), Decimal("0.0")),
        ...
        (
            ...
            Decimal("250190.0"),
            Decimal("976.0"),
        ),  # insurance cap = 260190, insurance rate = 9.76%
        (
            Decimal("10000.0"),
            Decimal("255190.0"),
            Decimal("488.0"),
...
def test_salary_utilities_calculate_pension_or_disability_insurance(
    social_security_base: Decimal, social_security_base_sum: Decimal, out: Decimal
) -> None:
