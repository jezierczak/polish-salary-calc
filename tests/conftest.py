...
@pytest.fixture
def employment_contract_gross_6000(rates_default,employment_settings_default) -> EmploymentContract:
    ec = EmploymentContract(rates_default,employment_settings_default)
    ec.calculate(Decimal("6000"))
    return ec

@pytest.fixture
def mandate_contract_gross_6000(rates_default,mandate_settings_default) -> MandateContract:
...
@pytest.fixture
def self_employment_gross_6000(rates_default,self_employment_settings_default) -> SelfEmployment:
