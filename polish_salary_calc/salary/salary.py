...
class Salary[T: ContractSettngs](SalaryExporter):
    ...
    def to_dict(self) -> Unpack[SalaryDict]:
        ...
        return {
            ...
            "social_insurance_sum": self.social_insurance_sum,
            "cost": self.cost,
    ...
    def __add__(self, other: "Salary") -> "Salary":
        ...
        output.social_security_base = (
            self.social_security_base + other.social_security_base
        )
        output.social_security_base_total = (
            other.contract_settings.social_security_base_sum + self.social_security_base
        )
        output.pension_insurance = self.pension_insurance + other.pension_insurance
        output.disability_insurance = (
            self.disability_insurance + other.disability_insurance
        )
        output.sickness_insurance = self.sickness_insurance + other.sickness_insurance
        output.social_insurance_sum = (
            self.social_insurance_sum + other.social_insurance_sum
        )
        output.author_rights_cost = self.author_rights_cost + other.author_rights_cost
        output.cost = self.cost + other.cost
        output.cost_fifty_total = (
            other.contract_settings.cost_fifty_sum + self.author_rights_cost
        )
        output.regular_cost = self.regular_cost + other.regular_cost
        output.author_rights_cost = self.author_rights_cost + other.author_rights_cost
        output.health_insurance_base = (
            self.health_insurance_base + other.health_insurance_base
        )
        ...
        output.tax_advance_payment = (
            self.tax_advance_payment + other.tax_advance_payment
        )
        output.salary_deductions = self.salary_deductions + other.salary_deductions
        output.employee_ppk_contribution = (
            self.employee_ppk_contribution + other.employee_ppk_contribution
        )
        output.net_salary = self.net_salary + other.net_salary
        output.employer_pension_contribution = (
            self.employer_pension_contribution + other.employer_pension_contribution
        )
        output.employer_disability_contribution = (
            self.employer_disability_contribution
            + other.employer_disability_contribution
        )
        ...
        output.employer_ppk_contribution = (
            self.employer_ppk_contribution + other.employer_ppk_contribution
        )
        output.total_employer_cost = (
            self.total_employer_cost + other.total_employer_cost
        )
        return output
