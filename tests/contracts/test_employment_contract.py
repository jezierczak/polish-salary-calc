...
def employment_contract_mock_6000_gross() -> MagicMock:
    ...
    employment_contract.author_rights_cost = Decimal('0.00')  # koszt praw autorskich (50%)
    ...
    employment_contract.employer_pension_contribution = Decimal('585.60')  # ub emeryt prac
    employment_contract.employer_disability_contribution = Decimal('390.00')  # ub rent prac
...
def test_employment_contract_6000_gross(employment_contract_mock_6000_gross) -> None:
    ...
    assert ec.accident_insurance == rates.accident_insurance_rate*ec.social_security_base
...
@pytest.mark.parametrize("salary_base,pension,disability,sickness,"
                         "health_insurance,cost,tax_advance,net,emp_pension,emp_disability,accident,fp,fgsp,total_gross",
                         [(Decimal('6000.00'),Decimal('585.60'),Decimal('90.0'),Decimal('147.0'),
                           Decimal('465.97'),Decimal('250.0'),Decimal('292'),Decimal('4419.43'),Decimal('585.60'),
                           Decimal('390.0'),Decimal('100.20'),Decimal('147.0'),Decimal('6.0'),Decimal('7228.80')),
                            (Decimal('15000.00'),Decimal('1464.00'),Decimal('225.0'),Decimal('367.50'),
                           Decimal('1164.92'),Decimal('250.0'),Decimal('1224'),Decimal('10554.58'),Decimal('1464.00'),
                           Decimal('975.0'),Decimal('250.50'),Decimal('367.50'),Decimal('15.0'),Decimal('18072.00')),
                                (Decimal('2000.00'), Decimal('195.20'), Decimal('30.0'), Decimal('49.00'),
                                 Decimal('155.32'), Decimal('250.0'), Decimal('0'), Decimal('1570.48'),
                                 Decimal('195.20'),Decimal('130.0'), Decimal('33.40'), Decimal('0'),
